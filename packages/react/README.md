...
During the beta line, prefer `npm install` over `pnpm add` for published Campos
...
Chart/model helpers currently live inside this package and are publicly
importable from the main barrel as a transitional advanced-use surface.
